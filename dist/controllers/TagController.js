...
exports.syncTags = exports.list = exports.removeAll = exports.remove = exports.update = exports.show = exports.kanban = exports.store = exports.index = void 0;
...
const DeleteAllService_1 = __importDefault(require("../services/TagServices/DeleteAllService"));
...
const removeAll = async (req, res) => {
    const { tagId } = req.params;
    await (0, DeleteAllService_1.default)();
    return res.send();
};
